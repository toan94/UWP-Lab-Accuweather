    ...
    public sealed partial class MainPage : Page
    {
        ...
        private async void InitJSON()
        {
            ...
            list.ForEach(it =>
            {
                ...
                it.WeatherIcon = string.Format("https://vortex.accuweather.com/adc2020/images/slate/icon/{0}.svg", it.WeatherIcon);
        ...
        {
            var urlFiveDay = "https://dataservice.accuweather.com/forecasts/v1/daily/5day/353412?" +  "apikey=CxILqfbYMdKI30fs02iXyl2JZJdF2MeU&language=vi-vn&metric=true";
            ...
            obj.DailyForecasts.ForEach(it =>
            {
                ...
                it.Day.Icon = string.Format("https://vortex.accuweather.com/adc2020/images/slate/icon/{0}.svg", it.Day.Icon);
